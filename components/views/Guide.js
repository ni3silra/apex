    ...
    <div className="view-container animate-fade-in" style={{ padding: 'var(--space-8)' }}>
      <div className="view-header" style={{ marginBottom: 'var(--space-6)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
          ...
          <div>
            <h1 className="view-title">APEX Guide</h1>
            <p className="view-subtitle">Master the command center</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <h2 style={{ color: 'var(--text-primary)', marginBottom: 'var(--space-4)', fontSize: '1.5rem' }}>Welcome to APEX Command Center</h2>
        <p style={{ color: 'var(--text-secondary)', marginBottom: 'var(--space-6)' }}>
          APEX is an enterprise-grade task management system built around the Eisenhower Matrix methodology. It forces you to prioritize tasks based on their Urgency and Importance, ensuring you spend your time on what truly matters.
        </p>
        ...
        <ul style={{ color: 'var(--text-secondary)', marginLeft: 'var(--space-5)', marginBottom: 'var(--space-6)' }}>
          <li style={{ marginBottom: 'var(--space-2)' }}><strong style={{ color: 'var(--danger)' }}>Q1: Do First (Urgent & Important)</strong> - Crises, deadlines, and emergencies. Do these immediately.</li>
        ...
        <ul style={{ color: 'var(--text-secondary)', marginLeft: 'var(--space-5)', marginBottom: 'var(--space-6)' }}>
          <li style={{ marginBottom: 'var(--space-2)' }}><strong>Dashboard (<code style={{background:'var(--surface)', padding:'2px 4px', borderRadius:'4px'}}>D</code>)</strong>: A high-level overview of your workload, daily focus, and upcoming deadlines.</li>
          ...
          <li style={{ marginBottom: 'var(--space-2)' }}><strong>Focus Mode (<code style={{background:'var(--surface)', padding:'2px 4px', borderRadius:'4px'}}>F</code>)</strong>: A dedicated Pomodoro-style timer to execute Q2 tasks without distraction. Focus time is tracked automatically.</li>
        ...
        <p style={{ color: 'var(--text-secondary)', marginBottom: 'var(--space-4)' }}>
          All your data is stored locally on your machine using the File System Access API. Your data never leaves your device. You can verify the storage connection in the bottom left of the sidebar.
        </p>
